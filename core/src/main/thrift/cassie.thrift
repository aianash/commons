...
service Cassie {
  ...
  common.StoreId createOrUpdateStore(1:common.StoreInfo info) throws (1:CassieException cex);
  common.StoreInfo getStoreInfo(1:common.StoreId storeId, 2:list<common.StoreInfoField> fields) throws (1:CassieException cex);
